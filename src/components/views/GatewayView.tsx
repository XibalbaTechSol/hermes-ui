  ...
  return (
    <div className="flex-1 flex flex-col bg-[#080808] overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
            ...
            {platforms.map(p => (
              <button
                ...
                className={`w-full flex items-center justify-between px-4 py-4 text-left border-l-2 transition-all ${
                  activePlatform === p 
                    ? 'bg-[#161616] border-[#FF4D00] text-[#E0E0E0]' 
                    : 'border-transparent text-[#555555] hover:text-[#B0B0B0] hover:bg-[#111111]'
                }`}
              >
                <div className="flex items-center gap-3">
        ...
        {/* CONFIG AREA */}
        <div className="flex-1 overflow-y-auto p-10 bg-[radial-gradient(circle_at_top_right,#111111,transparent)]">
          <div className="max-w-2xl mx-auto space-y-10">
            <div className="flex items-center justify-between p-6 bg-[#111111] border border-[#222222] rounded-xl shadow-2xl">
              <div>
                ...
                <p className="text-xs text-[#555555] mt-1">Configure bridge parameters for {activePlatform} neural link.</p>
              </div>
            ...
            <div className={`space-y-6 transition-opacity ${settings?.platforms[activePlatform]?.enabled ? 'opacity-100' : 'opacity-30 pointer-events-none'}`}>
              {(activePlatform === 'telegram' || activePlatform === 'discord' || activePlatform === 'slack') && (
                <div className="space-y-2">
                  <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest">Bot Token / API Secret</label>
                  <div className="relative">
                    <input 
                      ...
                      className="w-full bg-[#111111] border border-[#222222] px-4 py-3 text-sm text-[#E0E0E0] focus:border-[#FF4D00] outline-none transition-all rounded-lg"
                    />
              ...
              {activePlatform === 'telegram' && (
                <div className="space-y-6">
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest">Home Channel / Chat ID</label>
                    <input 
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest">Allowed Users (Comma separated)</label>
                    <input 
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label className="text-[10px] font-bold text-[#888888] uppercase tracking-widest">Reply Mode</label>
                    <select 
                      ...
                      className="w-full bg-[#111111] border border-[#222222] px-4 py-3 text-sm text-[#E0E0E0] focus:border-[#FF4D00] outline-none transition-all rounded-lg appearance-none"
                    >
              ...
              <div className="p-6 bg-[#161616] border border-[#222222] rounded-xl space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-xs font-bold text-[#B0B0B0]">STT AUTO-TRANSCRIBE</div>
                    <div className="text-[10px] text-[#444444] mt-0.5">Automatically transcribe inbound voice messages</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-xs font-bold text-[#B0B0B0]">NEURAL ISOLATION</div>
                    <div className="text-[10px] text-[#444444] mt-0.5">Isolate group sessions per participant</div>
                  </div>
                  <label className="relative inline-flex items-center cursor-pointer">
                    <input 
                      type="checkbox" 
